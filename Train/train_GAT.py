...
if __name__ == "__main__":
    ...
    # 创建模型
    model = GAT(in_channels=input_layer_dim, hidden_channels=hidden_layer_dim, out_channels=output_layer_dim).to(device)
    model.load_state_dict(torch.load('/home/zhuohang/SGG-GCN/pth/gcn_pth/2024-03-05-12-40-48/GAT_model_200.pth'))
    # 定义损失函数和优化器
    ...
    # for path in get_absolute_file_paths('/home/zhuohang/SGG-GCN/pth/gcn_pth/2024-03-05-12-40-48'):
    #     print(f'========{path}========')
    ...
    #         model_path = f"{save_folder_path}/GAT_model_{epoch+1}.pth"
