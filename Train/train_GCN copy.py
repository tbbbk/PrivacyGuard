...
if __name__ == "__main__":
    ...
    # model = torch.load('/home/zhuohang/SGG-GCN/pth/gcn_pth/[privacy1000]2024-02-25-15-37-48/[best]model_160.pth')
    # model.load_state_dict(torch.load('/home/zhuohang/SGG-GCN/pth/gcn_pth/GCN/GCN_model_200.pth'))
    # 定义损失函数和优化器
